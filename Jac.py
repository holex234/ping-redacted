...
class JacquesMod(loader.Module):
	...
	strings = {
		'name': 'ЖакМагик',
		'usage': '/jacm <текст/реплай на сообщение с текстом',
	}
	def __init__(self):
	...
	async def jacmcmd(self, message):
		...
		await message.edit("<b>Меджик...</b>")
		pic = requests.get("https://raw.githubusercontent.com/holex234/ping-redacted/main/staff/PicsArt_03-03-09.12.33.jpg")
